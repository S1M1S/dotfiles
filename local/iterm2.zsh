...
alias it2attention=${DF_CONFIG}/.iterm2/it2attention
alias it2check=${DF_CONFIG}/.iterm2/it2check
alias it2copy=${DF_CONFIG}/.iterm2/it2copy
alias it2dl=${DF_CONFIG}/.iterm2/it2dl
alias it2getvar=${DF_CONFIG}/.iterm2/it2getvar
alias it2git=${DF_CONFIG}/.iterm2/it2git
alias it2setcolor=${DF_CONFIG}/.iterm2/it2setcolor
alias it2setkeylabel=${DF_CONFIG}/.iterm2/it2setkeylabel
alias it2ul=${DF_CONFIG}/.iterm2/it2ul
alias it2universion=${DF_CONFIG}/.iterm2/it2universion
